...
#	@Copyright: Geovendas Soluções em TI, 2023
# --------------------------------------------------------------------------
# LICENSE
#
...
TITULO="Geovendas FusionInstall - v.1.1.1"o
BANNER="http://www.geovendas.com"
...
echo -e "Instalando Geovendas GLPI Fusion"
echo -e "Aguarde..."

sleep 5
echo -e "Efetuando umas paradas aleatorias"
sleep 5
echo -e "Mentira, tu esperou 10 segundos de vardia"
echo -e "Agora vamos iniciar..."
...
function setAgentConfig(){
		...
		then
			...
			GLPI_SERVER=$(whiptail --title "${TITULO}" --backtitle "${BANNER}" --inputbox "Enter the GLPi Server address: eg: https://empresa.geovendas.com." --fb 10 60 3>&1 1>&2 2>&3); [ $? -ne 0 ] && erroDetect
			...
			clear
			echo " - - - - - - - - - - - - - "
			echo " Enter the GLPi Server address: eg: https://empresa.geovendas.com."
			read GLPI_SERVER
...
#                    ERRO DETECTED!!!                       #
 ...
 ----------------------------------------------------------
  \033[32mGeovendas Solucoes em TI - http://www.geovendas.com\033[0m 
 ----------------------------------------------------------"
			...
			debian)
				...
				case $VERSION_ID in
					...
					11 | 10 | 9 | 8)
						...
						sleep 2
						echo "Starting fusioninstall.sh by Geovendas"
						echo "-----------------"; sleep 1;
...
|\033[34m Conheca nossos servicos e produtos.\033[0m                       |
 -----------------------------------------------------------
|\033[32m https://www.geovendas.com\033[0m                               |
 -----------------------------------------------------------
"
